...
class myCred_LearnPress_Instructor extends myCRED_Hook {
    ...
    function __construct( $hook_prefs, $type = 'mycred_default' ) {
        $defaults = array(
            'course_50' => array(
                'creds' => 5,
                'log' => '%plural%' . ' ' . __( 'for having a course with more than 50 learners', 'learnpress' ),
            ),
            'course_100' => array(
                'creds' => 10,
                'log' => '%plural%' . ' ' . __( 'for having a course with more than 100 learners', 'learnpress' ),
            ),
            'course_200' => array(
                'creds' => 20,
                'log' => '%plural%' . ' ' . __( 'for having a course with more than 200 learners', 'learnpress' ),
            ),
            'course_500' => array(
                'creds' => 100,
                'log' => '%plural%' . ' ' . __( 'for having a course with more than 500 learners', 'learnpress' ),
            ),
        );
    ...
    public function check_course( $status, $order_id ) {
        ...
        if ( $items = $order->get_items() ) {
            foreach ( $items as $item ) {
                ...
                /*
                  if ( $learners >= 50 && $learners < 100 ) {
                  $course_type = 'course_50';
                  } elseif ( $learners >= 100 && $learners < 200 ) {
                  $course_type = 'course_100';
                  } elseif ( $learners >= 200 && $learners < 500 ) {
                  $course_type = 'course_200';
                  } else {
                  $course_type = 'course_500';
                  } */
                ...
                // Execute
                $this->core->add_creds(
                        'learnpress_instructor', $instructor_id, $this->prefs[$course_type]['creds'], $this->prefs[$course_type]['log'], $course_id, array( 'ref_type' => 'post' ), $this->mycred_type
                );
            }
        }
    }
    ...
    public function preferences() {
        ...
        <label for="<?php echo $this->field_id( array( 'course_50' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for having course with more than 50 learners', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_50' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_100' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for having course with more than 100 learners', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_100' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_200' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for having course with more than 200 learners', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_200' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_500' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for having course with more than 500 learners', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'course_500' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
