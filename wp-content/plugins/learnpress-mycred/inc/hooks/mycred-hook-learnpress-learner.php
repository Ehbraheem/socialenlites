...
class myCred_LearnPress_Learner extends myCRED_Hook {
    ...
    function __construct( $hook_prefs, $type = 'mycred_default' ) {
        $defaults = array(
            'take_free_course' => array(
                'creds' => 1,
                'log' => '%plural%' . ' ' . __( 'for taking a free course', 'learnpress' ),
                'limit' => '1/d',
            ),
            'take_paid_course' => array(
                'creds' => 5,
                'log' => '%plural%' . ' ' . __( 'for taking a paid course', 'learnpress' ),
                'limit' => '1/d',
            ),
            'pass_course' => array(
                'creds' => 5,
                'log' => '%plural%' . ' ' . __( 'for passing a course', 'learnpress' ),
                'limit' => '1/d',
            ),
        );
    ...
    public function run() {
        ...
        add_action( 'learn_press_user_finish_course', array( $this, 'pass_course' ), 10, 3 );
    }
    ...
    public function pass_course( $course_id, $user_id, $result ) {
        ...
        if ( !$user->has( 'passed-course', $course_id ) ) {
            return;
        }
        ...
        if ( !$this->over_hook_limit( 'pass_course', 'learnpress_learner', $user_id ) ) {
            $this->core->add_creds(
                    'learnpress_learner', $user_id, $this->prefs['pass_course']['creds'], $this->prefs['pass_course']['log'], $course_id, array( 'ref_type' => 'post' ), $this->mycred_type
            );
        }
    }
    ...
    public function preferences() {
        ...
        <label for="<?php echo $this->field_id( array( 'take_free_course' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for taking a free course', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'take_free_course' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label class="subheader"><?php _e( 'Limit', 'learnpress' ); ?></label>
        <ol>
            <li>
        ...
        <label for="<?php echo $this->field_id( array( 'take_paid_course' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for taking a paid course', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'take_paid_course' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'pass_course' => 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for passing a course', 'learnpress' ) ); ?></label>
        <ol>
            <li>
                <div class="h2">
        ...
        <label for="<?php echo $this->field_id( array( 'pass_course' => 'log' ) ); ?>" class="subheader"><?php _e( 'Log Template', 'learnpress' ); ?></label>
        <ol>
            <li>
                <div class="h2">
