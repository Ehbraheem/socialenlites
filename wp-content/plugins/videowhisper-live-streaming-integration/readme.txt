...
== Description ==
VideoWhisper Live Streaming plugin allows site users and admins to broadcast live streaming channels from various sources (PC webcam, IP cameras, video playlists, mobile and desktop encoder apps).
Live channels can be displayed on website pages in web player with chat, tips or HTML5 HLS for mobile. Manage unlimited channels, membership types.

Functionality is stand alone (without need to use 3rd party services) so specific streaming hosting is required. Site owner has ownership and access control for content.

For more details see the dedicated site for [Broadcast Live Video](http://broadcastlivevideo.com/ "Broadcast Live Video") solution and [WordPress Live Video Streaming](http://www.videowhisper.com/?p=WordPress+Live+Streaming "WordPress Live Video Streaming") plugin homepage by VideoWhisper.
...
* iOS transcoding support for iPhone, iPad playback (on request/auto)
...
* [RealLifeCam Site Script for 24/7 Cams](http://www.turnkeyclone.com/reallifecam-site-script/ "RealLifeCam Site Script for 24/7 Cams")
* [Live Streaming App like Meerkat or Periscope](http://clone-app.com/live-streaming-app-like-meerkat-periscope-ustream-livestream-younow/ "Live Streaming App like Meerkat or Periscope")
...
This plugin has [requirements](http://www.videowhisper.com/?p=Requirements "Live Streaming Requirements") beyond regular WordPress hosting specifications: a [RTMP host](http://hostrtmp.com/ "RTMP Hosting") is needed for persistent connections to manage live interactions and streaming. More details about this, including solutions are provided on the Installation section pages.
...
http://www.videowhisper.com/?p=RTMP+Hosting
