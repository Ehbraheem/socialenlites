...
<p>Warning: If advanced session control is enabled you can't connect at same time with web broadcasting interface and external encoder (duplicate session will be refused by server). Connect with external encoder using details above and participate in chat with Watch interface. </p>
...
<br>For more details about available parameters and possible values see <a href="http://www.videowhisper.com/?p=php+live+streaming#integrate">PHP Live Streaming documentation</a>.
...
<br>To run this, make sure your hosting environment meets all <a href="http://www.videowhisper.com/?p=Requirements" target="_vwrequirements">requirements</a>.
...
yet (from a managed rtmp host), go to <a href="http://www.videowhisper.com/?p=RTMP+Applications" target="_blank">RTMP Application   Setup</a> for installation details.
...
<BR>This functionality is available with <a href="http://videowhisper.com/?p=Wowza+Media+Server+Hosting#plans" target="_vwhost">VideoWhisper Wowza plans</a>.
...
<BR>Warning: Enabling this disables event details, that show on channel page while channel is offline.
<?php
				break;
			case 'broadcaster':
