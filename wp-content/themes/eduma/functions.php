...
define( 'THIM_THEME_VERSION', '3.1.2' );
...
function add_custom_script() {
	...
	wp_enqueue_style('custom_multiselect_css', 'https://rawgit.com/nobleclem/jQuery-MultiSelect/master/jquery.multiselect.css' , array(), null );	
	
	
    wp_register_script('custom_scripts', get_theme_file_uri( '/assets/js/custom_scripts.js' ) , array( 'jquery' ), THIM_THEME_VERSION, true );
    wp_enqueue_script('custom_scripts');
	
	wp_register_script('custom_multiselect_scripts', 'https://rawgit.com/nobleclem/jQuery-MultiSelect/master/jquery.multiselect.js' , array( 'jquery' ), THIM_THEME_VERSION, true );
    wp_enqueue_script('custom_multiselect_scripts');
