...
if ( ! function_exists( 'thim_register_extra_fields' ) ) {
	function thim_register_extra_fields( $user_id ) {
		error_log("CUSTOMfUNCTION !!!!!!: thim_register_extra_fields");
...
if ( isset( $_POST['lmp_position'] )  ) {
		...
		if ( isset( $_POST['lmp_usertype'] )  && $_POST['lmp_usertype'] == "student" ) {
			$lmp_memberinterest = $_POST['lmp_memberinterest'];
...
if ( isset( $_POST['lmp_companyname'] )  ) {
			$lmp_companyname = $_POST['lmp_companyname'];
		}
			...
			else if ( isset( $_POST['lmp_usertype'] )  && $_POST['lmp_usertype'] == "lecturer" ) 
			{
				 // Get current user object
    $user = get_user_by( 'id', $user_id );
    // Add role
    $user->add_role( 'instructor' );
			...
			else if ( isset( $_POST['lmp_usertype'] )  && $_POST['lmp_usertype'] == "employee" ) {
