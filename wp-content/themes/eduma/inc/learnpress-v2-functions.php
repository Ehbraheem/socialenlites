...
function thim_update_user_profile_basic_information() {
  ...
  $lmp_office_phone ="";
			...
			$lmp_position ="";
				$lmp_memberlevel ="";
				$lmp_memberinterest =array();
		
		if ( isset( $_POST['lmp_memberlevel'] )  ) {
			$lmp_memberlevel = $_POST['lmp_memberlevel'];
		}

		if ( isset( $_POST['lmp_memberinterest'] )  ) {
			$lmp_memberinterest = $_POST['lmp_memberinterest'];
		}	

if ( isset( $_POST['lmp_office_phone'] )  ) {
			$lmp_office_phone = $_POST['lmp_office_phone'];
		}	
error_log("office: ".$lmp_office_phone);
if ( isset( $_POST['lmp_mobile_phone'] )  ) {
			$lmp_mobile_phone = $_POST['lmp_mobile_phone'];
		}	
error_log("lmp_mobile_phone: ".$lmp_mobile_phone);
if ( isset( $_POST['lmp_company'] )  ) {
			$lmp_company = $_POST['lmp_company'];
		}	
error_log("lmp_company: ".$lmp_company);
if ( isset( $_POST['lmp_position'] )  ) {
			$lmp_position = $_POST['lmp_position'];
		}		
    $lmp_usertype = '';
     $lmp_schoolname="";
      $lmp_schoolyear=""; 
     $lmp_industry="";
      $lmp_numemployee="";
		...
		if ( isset( $_POST['lmp_usertype'] ) ) {
    $lmp_usertype = $_POST['lmp_usertype'];
    if($_POST['lmp_usertype'] == "student")
    {
    if ( isset( $_POST['lmp_schoolname'] )  ) {
			$lmp_schoolname = $_POST['lmp_schoolname'];
		}	
    if ( isset( $_POST['lmp_schoolyear'] )  ) {
			$lmp_schoolyear = $_POST['lmp_schoolyear'];
		}	      
    }
    else if($_POST['lmp_usertype'] == "businessowner")
    {
    
    if ( isset( $_POST['lmp_numemployee'] )  ) {
			$lmp_numemployee = $_POST['lmp_numemployee'];
		}	
    if ( isset( $_POST['lmp_industry'] )  ) {
			$lmp_industry = $_POST['lmp_industry'];
		}	    
    }
    }
			$lmp_academicbackground="";
     
      $lmp_role="";  
      
       if ( isset( $_POST['lmp_role'] )  ) {
			$lmp_role = $_POST['lmp_role'];
		}	
    
      if ( isset( $_POST['lmp_academicbackground'] )  ) {
			$lmp_academicbackground = $_POST['lmp_academicbackground'];
		}	
