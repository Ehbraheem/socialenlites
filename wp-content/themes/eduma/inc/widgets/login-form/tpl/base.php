<?php
error_log("START".ABSPATH);
//include_once(ABSPATH ."wp-content\themes\eduma\override\class.utils.php");
	...
	<?php if ( !empty( $_GET['action'] ) && $_GET['action'] == 'register' ) : ?>
		<?php if ( get_option( 'users_can_register' ) ) : ?>
			...
			<div class="thim-login">
                ...
                <p><label for="first_name"><?php echo esc_attr_e('First Name', 'eduma') ?></label></p>
                <p><input type="text" id="first_name" size="50" name="first_name" /></p>
            </p>
            <p class="registration-lastname-row">
                <p><label for="last_name"><?php echo esc_attr_e('Last Name', 'eduma') ?></label></p>
                <p><input type="text" id="last_name" size="50" name="last_name" /></p>
            </p>			
			  <p width="25%" align="left">
			  <input id="lmp_usertype" name="lmp_usertype" type="text" style="display:none;" value="student"/>
                            <strong>User Level: <strong>
                        </p>
                        <p align="left">
                            <select name="lmp_memberlevel">
                                <option value="please_select">Select Current Level</option>
                                <?php echo Utils::course_Level_dropdown(); ?>
                            </select>                            
                        </p>
			<p>
			<td><label for="last_name"><?php echo esc_attr_e('Course Interest', 'eduma') ?></label></td>                
